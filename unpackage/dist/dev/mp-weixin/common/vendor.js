...
var getCarBrandList = function getCarBrandList() {
  return (0, _request.request)({
    method: 'POST',
    url: '/v1/carbrand/list',
    data: {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.submitToServe = exports.getPhoneNumber = exports.getMarketerInfo = exports.getBindedData = exports.gettoken = void 0;
...
//获取电话
exports.getMarketerInfo = getMarketerInfo;var getPhoneNumber = function getPhoneNumber(data) {
  return (0, _request.request)({
    method: 'POST',
...
//把电话提交到后端
exports.getPhoneNumber = getPhoneNumber;var submitToServe = function submitToServe(data) {
  return (0, _request.request)({
    method: 'POST',
...
};exports.submitToServe = submitToServe;
